...
(0, _neosUiExtensibility2.default)("main", {}, function (globalRegistry) {
    ...
    //
    config.set("addCodeToHeading", function (ckeConfig, _ref) {
        var editorOptions = _ref.editorOptions;

        if ((0, _plowJs.$get)("formatting.code", editorOptions)) {
    ...
    richtextToolbar.set("style/code", {
        ...
        label: "Code",
        isVisible: (0, _plowJs.$get)("formatting.code"),
        isActive: function isActive(formattingUnderCursor) {
            return (0, _plowJs.$get)("heading", formattingUnderCursor) === "code";
        }
    });
});
