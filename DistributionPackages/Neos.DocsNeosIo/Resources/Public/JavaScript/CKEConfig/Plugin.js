...
`;
  ...
  // src/codePlugin.js
  var import_ckeditor5_exports, CODE, CodeFormating;
  var init_codePlugin = __esm({
    "src/codePlugin.js"() {
      import_ckeditor5_exports = __toESM(require_ckeditor5_exports());
      init_attributecommand();
      CODE = "code";
      CodeFormating = class extends import_ckeditor5_exports.Plugin {
  ...
  var import_react, import_react_ui_components, IconButtonComponent, addPlugin;
  var init_manifest2 = __esm({
    "src/manifest.js"() {
      ...
      IconButtonComponent = class extends import_react.PureComponent {
        render() {
          const { formattingRule, inlineEditorOptions, i18nRegistry, tooltip, isActive, ...finalProps } = this.props;
          return /* @__PURE__ */ import_react.default.createElement(import_react_ui_components.IconButton, { ...finalProps, isActive: Boolean(isActive), title: tooltip });
        }
      };
      ...
      dist_default("main", {}, (globalRegistry) => {
